...
|---|---|---|
| `android.permission.RECORD_AUDIO` | permission | actively_recorded, ambient_context, automatically_recorded, chunk, chunk_closed, chunk_orphaned, chunk_seconds_target, chunk_upload_blocked |
...
| `android.permission.health.READ_HEART_RATE` | permission | direct_boot_migrated, epoch_calibrated, health_basal_metabolic_rate, health_heart_rate, health_respiratory_rate, health_resting_heart_rate, rate_limited, sampling_rate |
...
| `android.permission.health.READ_HEART_RATE_VARIABILITY` | permission | direct_boot_migrated, epoch_calibrated, health_basal_metabolic_rate, health_heart_rate, health_respiratory_rate, health_resting_heart_rate, rate_limited, sampling_rate |
| `android.permission.health.READ_RESPIRATORY_RATE` | permission | direct_boot_migrated, epoch_calibrated, health_basal_metabolic_rate, health_heart_rate, health_respiratory_rate, health_resting_heart_rate, rate_limited, sampling_rate |
| `android.permission.health.READ_RESTING_HEART_RATE` | permission | direct_boot_migrated, epoch_calibrated, health_basal_metabolic_rate, health_heart_rate, health_respiratory_rate, health_resting_heart_rate, rate_limited, sampling_rate |
...
| `android.permission.health.READ_VO2_MAX` | permission | health_vo2max, lux_max, max_bpm, motion_max, voltage_mv |
...
| `android.permission.health.READ_BASAL_METABOLIC_RATE` | permission | direct_boot_migrated, epoch_calibrated, health_basal_metabolic_rate, health_heart_rate, health_respiratory_rate, health_resting_heart_rate, rate_limited, sampling_rate |
